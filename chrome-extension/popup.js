...
(() => {
  ...
  var Popup = () => {
    ...
    const [apiBaseUrl, setApiBaseUrl] = (0, import_react.useState)("http://localhost:3000");
    const [statusMessage, setStatusMessage] = (0, import_react.useState)(null);
    const buildFallbackData = (tab) => ({
    ...
    const isRestrictedUrl = (url) => {
      if (!url) return true;
      return ["chrome://", "edge://", "about:", "chrome-extension://", "view-source:"].some((prefix) => url.startsWith(prefix));
    };
    (0, import_react.useEffect)(() => {
      chrome.storage.local.get(["token", "apiBaseUrl"], (result) => {
        setToken(result.token || null);
        setApiBaseUrl(result.apiBaseUrl || "http://localhost:3000");
      });
    ...
    if (!data) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { padding: 20 }, children: "Loading..." });
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { width: 350, padding: 16, fontFamily: "sans-serif" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { style: { fontSize: 16, marginBottom: 8, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: data.title || "Untitled Page" }),
      statusMessage && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 11, color: "#a16207", marginBottom: 8 }, children: statusMessage }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { fontSize: 12, color: "#666", marginBottom: 12 }, children: [
        data.description?.slice(0, 100),
        "..."
      ] }),
      data.image && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: data.image, alt: "Preview", style: { width: "100%", height: 120, objectFit: "cover", borderRadius: 8, marginBottom: 16 } }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginBottom: 12 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: { display: "block", fontSize: 12, fontWeight: "bold", marginBottom: 4 }, children: "Tags (comma separated)" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          children: loading ? "Saving..." : "Save to MyMind"
        }
      )
    ] });
  };
